...
var _blacklistUrl, _getProtocol_Domain_Path, _tryDomain, _unblacklistUrl, addToHttpList, addToHttpsList, blacklistUrl, forward_to, getList, lists, query, saveList, tryHttps, unblacklistUrl,
...
saveList = function(listname, list) {
  ...
  return localStorage[listname] = list;
};
